...
function BlockedTab({users} : Users) {
    ...
    return (
        ...
        <div className="flex flex-col overflow-scroll">
            {
                newUsers.map(user => (
                    <div className="flex justify-end items-center mx-10 border-t-[1.9px] group border-[#54545e] hover:bg-[#595965] rounded-lg md:justify-between cursor-pointer" key={user.userID} id={user.userID}>
                        <div className="hidden md:inline-flex relative items-center p-2 space-x-4 overflow-hidden whitespace-nowrap">
                            ...
                            <div className="flex flex-col overflow-x-hidden">
                                ...
                                <p className="text-zinc-400 font-medium select-none">Blocked</p>
                            </div>
                        </div>
